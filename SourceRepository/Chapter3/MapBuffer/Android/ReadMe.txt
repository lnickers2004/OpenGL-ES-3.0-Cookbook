...
Tags:            	glBufferData, glBufferSubData, glMapBufferRange, glUnmapBuffer
...
Introduction to Range Buffer Mapping

== Description ==
This recipe will demonstrate how to update the data of the buffer objects using range buffer mapping.
