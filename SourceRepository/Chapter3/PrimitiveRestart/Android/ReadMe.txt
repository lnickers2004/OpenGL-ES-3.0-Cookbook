...
Tags:            	GL_PRIMITIVE_RESTART_FIXED_INDEX, glDrawElementsInstanced 
...
== Description ==
Primitive Restart allows to render multiple disconnected geometrical primitives using a single API call.  
