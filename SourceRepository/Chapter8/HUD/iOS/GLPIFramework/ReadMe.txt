...
Head Up Display or Overlay.

== Description ==
Head Up Display or Overlay rendering allows to render the objects on the screen surface as like 2D surface, the most common use of it displaying text in the given screen position.

== Installation ==
Open the project by double clicking the .xcodeproj file.

== Changelog ==
1. Implement HUD GLPI framework - 28/11/2014