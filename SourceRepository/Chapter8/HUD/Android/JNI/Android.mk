...
include $(MY_CUR_LOCAL_PATH)/../../../../GLPIFramework/libpng/Android.mk \
    ...
    $(MY_CUR_LOCAL_PATH)/../../../../GLPIFramework/Font/harfbuzz-ng/Android.mk
...
LOCAL_C_INCLUDES := $(GLM_SRC_PATH)/core \
		...
		$(TEXTURE_LIB_PATH) \
		$(FONT_PATH)/FreeType/include \
		$(FONT_PATH)/harfbuzz-ng/src
...
LOCAL_SHARED_LIBRARIES := zlib GLPipng GLPift2 GLPiharfbuzz
#LOCAL_STATIC_LIBRARIES := GLPift2 GLPiharfbuzz
