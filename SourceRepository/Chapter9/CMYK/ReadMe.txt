...
Tags:            	OpenGLES first application, GLPI, OpenGLES in Android
...
Introduction to GLPI Framework.

== Description ==
Simple blue triangle application using our GLPI framework to demonstrate OpenGLES in Android.
...
== Changelog ==
1. Simple blue triangle application using our GLPI framework - 8/2/2014