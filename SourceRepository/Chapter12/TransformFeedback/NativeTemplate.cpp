...
bool GraphicsInit()
{
    ...
    camera1->MoveBackwards(2.0);
    //camera1->StrafeUpside(5.0);
    
    particles = new ParticleSystem(scene1, NULL, None, vertices, texCoords, (char*)"dir_up.png");
    particles->SetName(std::string("Direction Up"));
...
bool GraphicsRender()
{
    //buttonUp->RotateLocal(10.0, 0.0, 1.0, 0.0);
