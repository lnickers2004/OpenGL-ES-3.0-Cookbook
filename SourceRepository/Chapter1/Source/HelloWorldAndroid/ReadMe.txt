=== Simple OpenGLES Android Sample application ===
Contributors: 		Parminder Singh  
Author:     		Parminder Singh
Email:           	parminder_ce@yahoo.co.in
Tags:            	OpenGLES first application, OpenGL ES for Android, OpenGL ES 3.0
...
First OpenGL ES 3.0 application on Android.

== Description ==
This sample application demonstrate how to create a simple application of OpenGLES for Android.
...
== Changelog ==
1. Simple Hellow World Triangle application in Android using OpenGL ES 3.0 - 8/2/2014