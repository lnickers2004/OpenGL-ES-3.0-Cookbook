...
bool GraphicsInit()
{
    ...
    camera1->MoveBackwards(20.0);
    camera1->StrafeUpside(5.0);
...
//    camera3->Viewport(0, height/2, width/2, height/2);
//    camera3->SetClearColor(glm::vec4(1.0, 1.0, 1.0, 1.0));
//    camera4->Viewport(width/2, 0, width/2, height/2);
//    camera4->SetClearColor(glm::vec4(1.0, 0.0, 1.0, 1.0));
//    camera5->Viewport(width/2, height/2, width/2, height/2);
//    camera5->SetClearColor(glm::vec4(1.0, 1.0, 0.0, 1.0));
